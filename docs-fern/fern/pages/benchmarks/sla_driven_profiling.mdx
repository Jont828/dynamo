...
3. **Parallelization Mapping Sweep**: Use the input ISL and OSL, test the performance of the engines with different parallelization mappings.
   ...
   ![Prefill Performance](../../assets/img/h100_prefill_performance.png)
   ...
   ![Decode Performance](../../assets/img/h100_decode_performance.png)
...
![ITL Interpolation](../../assets/img/pd_interpolation.png)
