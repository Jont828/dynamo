...
main.fern-main:has(.dynamo-examples, .dynamo-example-viewer):not(:has(> .fern-layout-content-wrapper ~ aside)) .fern-layout-guide > article {
  margin-left: 0 !important;
  margin-right: auto !important;
}
.dynamo-examples, .dynamo-example-viewer {
  width: 100%;
  max-width: 100%;
  min-width: 0;
  margin-inline: 0;
