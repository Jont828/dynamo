...
<CardGroup cols={2}>
  ...
  <Card title="Browse Deployment Examples" icon="regular copy" href="../../recipes/examples/overview.mdx">
    Choose an aggregated, disaggregated, or multinode example, then select Kubernetes and your backend.
  </Card>
