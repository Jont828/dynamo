...
<Steps toc={true}>
<Step title="Install gcloud CLI" id="install-gcloud-cli">
https://cloud.google.com/sdk/docs/install

</Step>
<Step title="Create GKE cluster" id="create-gke-cluster">
```bash
export PROJECT_ID=<>
export REGION=<>
export ZONE=<>
...
<Step title="Clone Dynamo GitHub repository" id="clone-dynamo-github-repository">
...
<Step title="Set environment variables for GKE" id="set-environment-variables-for-gke">
```bash
...
<Step title="Deploy Inference Graph" id="deploy-inference-graph">
...
For example, refer to the [`release/1.2.1` disaggregated manifest](https://github.com/ai-dynamo/dynamo/blob/release/1.2.1/examples/deployments/GKE/vllm/v1beta1/disagg.yaml):
...
<Step title="Deploy the model" id="deploy-the-model">
```bash
...
<Step title="Test the Deployment" id="test-the-deployment">
```bash
