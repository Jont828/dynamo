...
<AccordionGroup>
<Accordion title="agg_image_diffusion.yaml · FLUX.1-schnell text-to-image">
...
<Accordion title="agg_video_diffusion.yaml · Wan 2.1 text-to-video and image-to-video">
<Code src="../../../../../../examples/backends/sglang/deploy/agg_video_diffusion.yaml" title="agg_video_diffusion.yaml" language="yaml" maxLines={0} />
</Accordion>
<Accordion title="agg_llm_diffusion.yaml · LLaDA 2.0 diffusion language model">
