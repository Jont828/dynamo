...
| `AGG_ENGINE_ARGS` | `$DYNAMO_HOME/examples/backends/trtllm/engine_configs/qwen3-vl-2b-instruct/agg_kv_router.yaml` | TensorRT-LLM engine configuration for the aggregated worker. |
